# Databricks notebook source exported at Mon, 25 Jul 2016 01:38:23 UTC
# MAGIC %md
...
# TODO: Replace <FILL IN> with appropriate code
wordCountsGrouped = wordsGrouped.map(lambda t: (t[0],sum(t[1])))
...
def wordCount(wordListRDD):
    ...
    """
    return wordListRDD.map(lambda t: (t,1)).reduceByKey(lambda a,b: a+b)
...
# TODO: Replace <FILL IN> with appropriate code
shakespeareWordsRDD = shakespeareRDD.flatMap(lambda t: t.split(" "))
...
# TODO: Replace <FILL IN> with appropriate code
shakeWordsRDD = shakespeareWordsRDD.filter(lambda t: t!="")
